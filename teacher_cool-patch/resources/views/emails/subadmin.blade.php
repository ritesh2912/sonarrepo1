...
<body class="antialiased">
    ...
    <table style="text-align: center; width:550px; background: #fff; border-collapse: collapse;  " align="center"
        cellpadding="0" cellspacing="0">
        <tbody>
            <tr>
                <td
                    style="padding:26px 0 16px;color:#7D36CC;font-size:24px;font-weight:500;line-height: 26px; border-top: 8px solid #3F1272;">
                    Greetings! {{$receiver_name}}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding: 50px 0 15px;font-size: 13px;color: #888888;"> {{ env('APP_NAME', 'Teacher Cool') }}
                    - All copyrights reserved 2023</td>
            </tr>
        </tbody>
    </table>
</body>
