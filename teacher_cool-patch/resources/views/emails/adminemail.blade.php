                ...
                <td align="center" style="padding:0;">
                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                       ...
                       text-underline-color:#1670F8">
                                ...
                                @endif
                                @if(isset($profile_url) && $profile_url != null)
                                <p style="text-align: center;margin: 2.5em auto;">
                                    <a class="button" href={{ $profile_url }} style="background: #1670F8; 
                       text-decoration: none; 
                       padding: 1em 1.5em;
                       color: #ffffff; 
                       border-radius: 48px;
                       ...
                       text-underline-color:#1670F8">
                                        <i style="letter-spacing: 25px;mso-font-width:-100%;mso-text-raise:20pt">&nbsp;</i>
                                        <span style="mso-text-raise:10pt;font-weight:bold;">View Profile</span>
                                        <i style="letter-spacing: 25px;mso-font-width:-100%">&nbsp;</i>
                                    </a>
                                </p>
                                @endif
