                    ...
                    <table role="presentation" style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                        ...
                        <tr>
                            <td style="padding:30px;background-color:#f5f5f5;">
                                <h1 style="text-align: center; margin-top:0;font-size:1.953em;line-height:1.3;font-weight:bold;letter-spacing:-0.02em;margin-bottom:10;color:#7D36CC;">
                                    Greetings! {{ env('APP_NAME', 'Teacher Cool') }}</h1>
                                <p style="text-align: center; margin:0;">Dear Admin,
                                </p>
                                <!-- <p style="text-align: center;">Welcome To  {{ env('APP_NAME', 'Teacher Cool') }},</p> -->
                                <p style="text-align: center;">{{$body}}</p>
                                <table style="width:94%;max-width:600px;border:none;border-spacing:0;text-align:left;font-family:'Basier Circle', 'Roboto', 'Helvetica', 'Arial', sans-serif;font-size:1em;line-height:1.37em;color:#384049;">
                                    <tr>
                                        <th>Email</th>
                                        <td>{{$reqData['email']}}</td>
                                    </tr>
                                    <tr>
                                        <th>Contact</th>
                                        <td>{{$reqData['contact']}}</td>
                                    </tr>
                                    <tr>
                                        <th>Deadline</th>
                                        <td>{{$reqData['due_date']}}</td>
                                    </tr>
                                    <tr>
                                        <th>Category</th>
                                        <td>{{$reqData['category']}}</td>
                                    </tr>
                                    @if(isset($reqData['category_other']) && $reqData['category_other'] != '')
                                    <tr>
                                        <th>Category Other</th>
                                        <td>{{$reqData['category_other']}}</td>
                                    </tr>
                                    @endif
                                    <tr>
                                        <th>Subject</th>
                                    ...
                                    <tr>
                                        <th>Word Count</th>
                                        <td>{{$reqData['word_count']}}</td>
                                    </tr>
                                    <tr>
                                        <th>Question </th>
                                        <td>{{$reqData['question']}}</td>
                                    </tr>
                                </table>
                                <p>
