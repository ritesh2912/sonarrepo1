...
function createMeeting($data = array(), $email = null)
{
    ...
    $request_url = "https://api.zoom.us/v2/users/" . env('ZOOM_EMAIL_ID') . "/meetings";
    $token = array(
        "iss" => env('ZOOM_API_KEY'),
        "exp" => time() + 3600 //60 seconds as suggested
        
    );
    $getJWTKey = JWT::encode($token, env('ZOOM_API_SECRET'));
    $headers = array(
